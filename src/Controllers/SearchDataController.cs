...
namespace flightsearch.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        {
            using (TextReader reader = System.IO.File.OpenText(_env.ContentRootPath + @Path.DirectorySeparatorChar + "App_Data" + Path.DirectorySeparatorChar + "airports.csv"))
            {
        ...
        public JsonResult Flights()
        {
            ...
            using (TextReader reader = System.IO.File.OpenText(_env.ContentRootPath + @Path.DirectorySeparatorChar + "App_Data" + Path.DirectorySeparatorChar + "flights.csv"))
            {
                try{
                    var csv = new CsvReader(reader);
